...
export const CONFIG: AsistenteConfig = {
  ...
  contexto:
    "Fundada en 1968: más de 50 años de trayectoria y 3 generaciones vendiendo, alquilando y administrando inmuebles. El objetivo de la casa es trabajar en el camino de la excelencia sobre la base de la confianza, la seriedad y la trayectoria, buscando maximizar el valor de las inversiones de los clientes. Ofrece asesoramiento integral: tasaciones sin cargo con informe escrito, ventas, alquileres y administración. Dos oficinas: Oficina 1 en Córdoba 3719 (Chauvín), tel. 223 512-9032, y Oficina 2 en Av. de los Trabajadores 2439 (Punta Mogotes), tel. 223 628-2659. Horarios: Chauvín, lunes a viernes de 9 a 16; Punta Mogotes, lunes a viernes de 9 a 18 y sábados hasta las 12.",
};
