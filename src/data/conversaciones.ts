...
export const conversaciones: Conversacion[] = [
  {
    ...
    mensajes: [
      m("cliente", "Hola! Vi el 3 ambientes a estrenar en Güemes. ¿Sigue disponible?", 384),
      m("ia", "¡Hola Nicolás! Sí, sigue disponible 🙂 Es un 3 ambientes a estrenar en Güemes, con cochera opcional. ¿Querés que coordinemos una visita esta semana?", 383),
  ...
  },
  {
    ...
    mensajes: [
      ...
      m("ia", "¡Hola Sofi! Sí, trabajamos alquiler temporario por quincena. Para enero tenemos disponibilidad en Playa Grande, Güemes y La Perla. ¿Cuántas personas son y qué quincena buscás?", 189),
      m("cliente", "somos 4, la segunda de enero", 185),
      m("ia", "Para 4 personas en la 2ª quincena de enero tengo un 3 ambientes en Playa Grande con vista al mar. Es la quincena más pedida, así que conviene definirla pronto. ¿Me dejás tu teléfono y te mando fotos y valores?", 184),
  ...
  },
  {
    ...
    mensajes: [
      m("cliente", "Hola, ¿tomarían mi departamento como parte de pago por la casa de San Carlos?", 260),
  ...
  },
  {
    ...
    noLeida: false,
    mensajes: [
      m("cliente", "Estimados: consultamos por el local de la peatonal. Solicitamos renta actual y vencimiento del contrato vigente. Quedamos a la espera.", 610),
      m("ia", "Estimados, gracias por escribir a Potente Propiedades. El local de la peatonal está publicado en venta con contrato de alquiler vigente. La renta actual y el vencimiento se los confirma un asesor por escrito. ¿Nos dejan un teléfono de contacto para coordinar? — Equipo Potente Propiedades", 608),
  ...
  },
  {
    ...
    mensajes: [
      m("cliente", "Hola, nos interesa el depto frente al mar de Varese para la 2ª de enero. ¿Cómo es la seña?", 55),
